...
export const USER: User = {
  ...
  about: `
I'm Margo — a Computer Science graduate who fell for the front of the stack. I build production interfaces with React, Next.js, and TypeScript at Inklusiv, 
focusing on the details most people never notice but always feel.
